            ...
            <div class="row d-flex align-items-center bg8">
                ...
                <div class="col col-12">
                    <div class="">
                      ...
                      <div>
                        <h3> Types of information Collected by Taxtds: </h3>
                        <h4> Users/Customers </h4>
                        <ol>
                            <li>  Personal Identifying information such as name, address and phone numbers; email Id, Age, personal description, profile photograph etc., & delivery address,
                            </li>
                            ...
                            <li>  Name, addresses & phone numbers, e-mail IDs of friends and other people listed in Addresses;
                            </li>
                            <li>  Content of reviews and e-mails to us.
                            </li>
                            <li>  voice recordings when you call to us.
                            </li>
                            <li>  credit usage, login detail, device log files etc., while using our platform.
                            </li>
                        ...
                        <ol>
                            <li>  Personal Identifying information such as name, address and phone numbers; email Id, Age, personal description, profile photograph ,Marital status etc.,.
                            </li>
                            <li>  payment information.
                            </li>
                            <li>  location information.
                            ...
                            <li>  information and officially valid documents (KYC regarding identity and address information, including mobile & landline number, place of business, valid Email id, vendor’s photo, id & address proof (such as Aadhar card, Pan Card, GST Voter Id Card, Passport, Shop and Establishment Certificate, etc.,.
                            </li>
                            <li>  credit usage
                            </li>
                            <li>  corporate and financial information, and
                            </li>
                            <li>  device log files and configurations etc.,.
                            </li>
                            
                        </ol>
                      </div>
                      <div class="">
                        <h3> Taxtds Doesn’t Collect the Information </h3>
                        <p>
                            Taxtds does not collect sensitive personal data or information. It only collects the sensitive personal data or information which is considered necessary to provide the service or to fulfil the purpose and for a lawful purpose connected with a function or activity of Taxtds. User can continue to browse / search on Taxtds.com without giving any information; however, PI is required for availing the certain services on Justdial’s platform.
                        </p>
                        <p>
                            Any information which can related to personal and bank account and other any information which can impact the customer and client sensitive information
                        </p>
                      </div>
                </div>
